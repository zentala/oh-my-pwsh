...
- [ ] **Brak trybu nieinteraktywnego w Power Tools** — dodac `-NonInteractive`
  (i krotsze `-Quiet`) do runnera, zeby komendy nie wyswietlaly promptow, dzialaly
  deterministycznie w skryptach i CI oraz zwracaly czytelne kody wyjscia.
  Zgloszone 2026-09-02. (Importance: Medium, Points: 3)
- [ ] **Research narzedzi porownywalnych z Power Tools** — przeglad alternatyw
  (funkcje, DevEx, UX, testy, dokumentacja deploymentu) i wnioski dla dalszego
  rozwoju. Zgloszone 2026-09-02. (Importance: Low, Points: 3)
